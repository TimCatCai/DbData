...
public class DataUtils {
    ...
    public  static String dateType(String date){
        return "CONVERT(VARCHAR(40)," + DataUtils.stringType(date) + ",23)";
    }

    public static String generateRandomDate(int startDate, int endDate){
        return dateFormat(RandomUtils.nextInt(startDate, endDate), RandomUtils.nextInt(1,13),RandomUtils.nextInt(1, 29));
    }
    ...
    public static String generateSexString(){

        return convertSexCodeToSexString(RandomUtils.nextInt(0,2));
    }
